...
###############################################################
###############################################################
### basic personal setup v2.1 debian                        ###
###############################################################
...
sudo apt install plasma-desktop plasma-workspace plasma-desktop plasma-workspace kde-baseapps sddm xserver-xorg kwin-x11 kde-config-systemd -y #-t Debian_Unstable 
